...
export class ThemeSwitcher extends LitElement {
  ...
  firstUpdated() {
    ...
    const _heroImage = document.querySelector('#home-hero-image') as HTMLImageElement;
		if (theme === 'default') {
			_heroImage.src = '/assets/seafloor/obs2.png';
		}
		if (theme === 'dark') {
			_heroImage.src = '/assets/seafloor/ocean2.png';
		}
		if (theme === 'earth') {
			_heroImage.src = '/assets/seafloor/ship_scan.png';
		}
		if (theme === 'ocean') {
			_heroImage.src = '/assets/images/home/ocean-hero.jpg';
		}
		if (theme === 'sand') {
			_heroImage.src = '/assets/seafloor/obs1.png';
		}
